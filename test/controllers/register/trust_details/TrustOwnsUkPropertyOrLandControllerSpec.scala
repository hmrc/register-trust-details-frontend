...
class TrustOwnsUkPropertyOrLandControllerSpec extends SpecBase {
  ...
  "TrustOwnsUkPropertyOrLandController" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val view = application.injector.instanceOf[TrustOwnsUkPropertyOrLandView]
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.set(TrustOwnsUkPropertyOrLandPage, validAnswer).success.value
