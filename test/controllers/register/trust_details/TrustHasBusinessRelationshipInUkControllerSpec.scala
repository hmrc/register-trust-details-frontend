...
class TrustHasBusinessRelationshipInUkControllerSpec extends SpecBase {
  ...
  "TrustHasBusinessRelationshipInUkController" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val view = application.injector.instanceOf[TrustHasBusinessRelationshipInUkView]
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.set(TrustHasBusinessRelationshipInUkPage, validAnswer).success.value
