  ...
  .settings(
    ...
    Concat.groups := Seq(
      "javascripts/registertrustdetailsfrontend-app.js" ->
        group(Seq("javascripts/show-hide-content.js", "javascripts/registertrustdetailsfrontend.js"))
    ),
    ...
    includeFilter in uglify := GlobFilter("registertrustdetailsfrontend-*.js")
  )
